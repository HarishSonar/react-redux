...
class DemoClass extends React.Component {
    ...
    updateCustName(e) {
        console.log("Update customer name called");
        // console.log(this.refs.custName.value);
        // this.setState({custName: this.refs.custName.value});
    }
    ...
    render() {
        ...
        return (
            <div>
                <input type="text" ref={this.testCallback} onChange={this.updateCustName.bind(this)} />
                Hello {this.state.custName}
